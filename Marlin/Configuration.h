...
#define STRING_CONFIG_H_AUTHOR "(MG|Josh, M2 General)" // Who made the changes.
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 175  // WAS 185 
    #define BACK_PROBE_BED_POSITION  202  // WAS 240
  ...
  #define Z_RAISE_BEFORE_HOMING 15       // (in mm) Raise Z before homing (G28) for Probe Clearance. Was 30
                                        // Be sure you have this distance over your Z_MAX_POS in case

  #define XY_TRAVEL_SPEED 8000         // X and Y axis travel speed between probes, in mm/min

  #define Z_RAISE_BEFORE_PROBING 15    //How much the extruder will be raised before traveling to the first probing point. Was 30
  #define Z_RAISE_BETWEEN_PROBINGS 10  //How much the extruder will be raised when traveling from between next probing points. Was 15
...
#define HOMING_FEEDRATE {50*60, 50*60, 5*60, 0}  // set the homing speeds (mm/min) // Z WAS 15*60
...
//#define LCD_HAS_SLOW_BUTTONS //doesn't work - Josh, 8/17/2015
