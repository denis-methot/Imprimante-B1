...
#define STRING_CONFIG_H_AUTHOR "(Infini3d - Grosse Berta 2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Grosse Berta 2"
...
// DME: New define to swap E0 and E1 pins assignment.
//      Define to set E1 as the default extruder.
//      Undefine to keep E0 as default extruder
#undef SWAP_E0_E1
 ...
 */
#define TEMP_SENSOR_0 66  // DME: Inscrire 999 pour tests standalone, 66 pour version normale
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // Infini-3d "Grosse Berta" Dyze hot end
...
#define NEMA17_FULL_STEPS         200.0	// Doc du stepper
#define NEMA17_XY_MICROSTEPS      16.0	// Voir Configuration_adv.h, MICROSTEP_MODES
#define NEMA17_Z_MICROSTEPS       16.0  // Voir Configuration_adv.h, MICROSTEP_MODES
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 20, 3000 }
 ...
 */
#define BLTOUCH // DME: Disabled during standalone tests
#if ENABLED(BLTOUCH)
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // DME: Disabled during standalone tests
...
#define AUTO_BED_LEVELING_BILINEAR // DME: Disabled during standalone tests
